...
```
## Experiment Scenario
We used Astyx HiRes2019 as the dataset for our experiments. Since the majority of the data in this dataset are cars, and the number of pedestrians and bicyclists is very small, we chose only cars in the dataset as the experimental subjects in order to ensure the high reproducibility of the experimental results.
